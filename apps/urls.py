...
urlpatterns = [
    ...
    path('api/user/', include('apps.user.urls')),  # 用户相关
    path('api/company/', include('apps.company.urls')),  # 企业相关
    path('api/job/', include('apps.job.urls')),  # 职位相关
    path('api/work/', include('apps.work.urls')),  # 职位详情相关
    path('api/student/', include('apps.student.urls')),  # 学生相关
    path('api/resume/', include('apps.resume.urls')),  # 学生相关
    path('api/recruit/', include('apps.recruit.urls')),  # 学生相关
    # drf_yasg
