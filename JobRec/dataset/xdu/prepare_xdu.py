...
class zhilian:
    ...
    def get_inter(self):
        f = open(r'G:\西电就业数据集\训练数据集\csv\最少字段缺值_1w\xdu_dataset_action_top1w.csv', 'r', encoding='utf-8')
        f_target = open(r'G:\JobRecProject_v2\JobRec\dataset\xdu\xdu.inter', 'w', encoding='utf-8')
        f.readline()
    ...
    def get_user_item(self, u_columns):
        ...
        # 打开原始CSV文件和新文件
        with open(r'G:\西电就业数据集\训练数据集\csv\最少字段缺值_1w\xdu_dataset_user_top1w.csv', 'r',
                  encoding='utf-8') as f:
            with open(r'G:\JobRecProject_v2\JobRec\dataset\xdu\xdu.user', 'w', encoding='utf-8', newline='') as f_user:
                reader = csv.reader(f)
        ...
        # 打开工作数据文件进行读取
        with open(r'G:\西电就业数据集\训练数据集\csv\最少字段缺值_1w\xdu_dataset_job_top1w.csv', 'r', encoding='utf-8') as f:
            with open(r'G:\JobRecProject_v2\JobRec\dataset\xdu\xdu.item', 'w', encoding='utf-8', newline='') as f_item:
                reader = csv.reader(f)
    ...
    def get_docs(self):
        ...
        with open(r'G:\西电就业数据集\训练数据集\csv\最少字段缺值_1w\xdu_dataset_user_top1w.csv', 'r', encoding='utf-8') as f:
            reader = csv.DictReader(f)
            with open(r'G:\JobRecProject_v2\JobRec\dataset\xdu\xdu.udoc', 'w', encoding='utf-8', newline='') as f_udoc:
        ...
        with open(r'G:\西电就业数据集\训练数据集\csv\最少字段缺值_1w\xdu_dataset_job_top1w.csv', 'r', encoding='utf-8') as f:
            reader = csv.DictReader(f)
            with open(r'G:\JobRecProject_v2\JobRec\dataset\xdu\xdu.idoc', 'w', encoding='utf-8', newline='') as f_idoc:
