...
def train_job_model():
    ...
    parser.add_argument('--pretrainuserembedding', type=str, dest='pre_train_user_embedding',
                        default='data/xdu/pre-train-user-embedding_com.txt')
    parser.add_argument('--pretrainmovieembedding', type=str, dest='pre_train_movie_embedding',
                        default='data/xdu/pre-train-item-embedding_com.txt')
    ...
    parser.add_argument('--results', type=str, dest='results', default='data/xdu/results_com.txt')
    # todo 防止报错
    ...
    # 保存到文件
    with open('data/xdu/recommend_result_com', 'w') as f:
