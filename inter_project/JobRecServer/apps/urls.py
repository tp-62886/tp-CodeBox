...
# from apps.middle.models import ClickJob, CompanyCode
...
urlpatterns = [
    ...
    path('api/user/', include('JobRecServer.apps.user.urls')),  # 用户相关
    path('api/company/', include('JobRecServer.apps.company.urls')),  # 企业相关
    path('api/job/', include('JobRecServer.apps.job.urls')),  # 职位相关
    path('api/work/', include('JobRecServer.apps.work.urls')),  # 职位详情相关
    path('api/student/', include('JobRecServer.apps.student.urls')),  # 学生相关
    path('api/resume/', include('JobRecServer.apps.resume.urls')),  # 学生相关
    path('api/recruit/', include('JobRecServer.apps.recruit.urls')),  # 学生相关
    # drf_yasg
